    ...
    <article className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mt-8 space-y-6 text-slate-700 dark:text-slate-300 [&_h2]:mt-8 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-slate-900 dark:[&_h2]:text-white">
        ...
        <p>
          ...
          through Google OAuth. We also receive a Google API token that allows us
          to create and edit Google Slides presentations on your behalf.
        </p>
        ...
        <p>
          GlideDeck accesses Google Slides and Google Drive on your behalf using
          OAuth tokens. We do not store the content of your presentations on our
          servers. Presentations are created and stored in your own Google Drive
          account.
        </p>
